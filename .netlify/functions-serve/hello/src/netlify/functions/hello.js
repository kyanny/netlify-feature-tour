...
var require_entities = __commonJS({
  "node_modules/xmldom/lib/entities.js"(exports2) {
    exports2.entityMap = {
      lt: "<",
      gt: ">",
      amp: "&",
...
var require_sax = __commonJS({
  "node_modules/xmldom/lib/sax.js"(exports2) {
...
var require_dom = __commonJS({
  "node_modules/xmldom/lib/dom.js"(exports2) {
    ...
    function DOMException3(code, message) {
    ...
    DOMException3.prototype = Error.prototype;
    copy(ExceptionCode, DOMException3);
    function NodeList() {
    }
    NodeList.prototype = {
      length: 0,
    ...
    function _removeNamedNode(el, list, attr) {
      ...
      if (i2 >= 0) {
        ...
        throw DOMException3(NOT_FOUND_ERR, new Error(el.tagName + "@" + attr));
      }
    }
    NamedNodeMap.prototype = {
      ...
      setNamedItem: function(attr) {
        ...
        if (el && el != this._ownerElement) {
          throw new DOMException3(INUSE_ATTRIBUTE_ERR);
        }
    ...
    var getTextContent;
    exports2.Node = Node;
    exports2.DOMException = DOMException3;
...
var require_dom_parser = __commonJS({
  "node_modules/xmldom/lib/dom-parser.js"(exports2) {
...
// node_modules/node-lcs/index.js
var require_node_lcs = __commonJS({
  "node_modules/node-lcs/index.js"(exports2, module2) {
        ...
        for (j = 0; j < str2Length; j++) {
          if (str1[i2] !== str2[j]) {
            ...
            if (i2 === 0 || j === 0) {
              ...
              num[i2][j] = 1 + num[i2 - 1][j - 1];
            }
            if (num[i2][j] > maxlen) {
              maxlen = num[i2][j];
              thisSubsBegin = i2 - num[i2][j] + 1;
              if (lastSubsBegin === thisSubsBegin) {
                sequence += str1[i2];
              } else {
                lastSubsBegin = thisSubsBegin;
                sequence = "";
                sequence += str1.substr(lastSubsBegin, i2 + 1 - lastSubsBegin);
              }
            }
          }
        }
    ...
    module2.exports = longestCommonSubstring;
  }
});
...
var import_node_lcs = __toModule(require_node_lcs());
exports.handler = async function(event, context) {
  ...
  const episodeTitle = await fetch(episodeUrl).then((res) => res.text()).then((html) => {
    const doc2 = new import_xmldom.DOMParser().parseFromString(html, "text/html");
    return doc2.getElementsByTagName("title")[0].textContent;
  });
  const podcast = Object.keys(podcastsRss).find((key) => {
    const result = (0, import_node_lcs.default)(key, episodeTitle);
  ...
  const doc = await fetch(podcastsRss[podcast]).then((res) => res.text()).then((xml) => {
    const doc2 = new import_xmldom.DOMParser().parseFromString(xml, "text/xml");
    return doc2;
  });
  const items = doc.getElementsByTagName("item");
  const item = Array.prototype.find.call(items, (item2) => {
    const title = item2.getElementsByTagName("title")[0].textContent;
    const result = (0, import_node_lcs.default)(episodeTitle, title);
